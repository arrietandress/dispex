	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">REGISTRAR EPS</h3>
				...
				<input type="email" class="form-control" placeholder="Ingresar codigo">			
				</div>

				<div class="form-group">
				<label for="exampleInputEmail1">Razon Social</label>
				<input type="email" class="form-control" placeholder="Ingresar razon social">	
				</div>

				<div class="form-group">
				<label for="exampleInputEmail1">Dirección</label>
				<input type="email" class="form-control" placeholder="Ingresar dirección">	
				</div>

				<div class="form-group">
				<label for="exampleInputEmail1">Telefono</label>
				<input type="email" class="form-control" placeholder="Ingresar telefono">	
				</div>

				  <div class="form-group">
				    <label for="exampleSelect1">Regimen</label>
				  ...
				  <div class="form-group">
				<label for="exampleInputEmail1">Representante Legal</label>
				<input type="email" class="form-control" placeholder="Ingresar nombre representante legal">	
				</div>
				 
				  <a type="submit" class="btn btn-success">Guardar</a>
				  <a type="submit" class="btn btn-info" href="page-list.php">Cancelar</a>
				</form>
						</div>
					</div>
					<!-- END OVERVIEW -->
