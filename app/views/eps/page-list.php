	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="../page-dasboard.php" class=""><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">LISTADO DE EPS</h3>
							<p class="panel-subtitle">Periodo: Mayo 4, 2017</p>

						</div>
						<div class="panel-body">
							<!--contenido-->
							<table class="table table-bordered" id="list_eps" >
										<thead>
											<tr>
												<th>CODIGO</th>
												<th>RAZON SOCIAL</th>
										...
										<tbody>
										<?php  
										$sql = "SELECT codigo_eps,razon_eps,direccion_eps,telefono_eps,regimen_eps FROM eps";
                                                   $result = $con->query($sql);

										while ($row = mysqli_fetch_assoc($result)) { ?>
										<tr>
										            <td><?php echo $row['codigo_eps'] ?></td>
												 	<td><?php echo $row['razon_eps'] ?></td>
												 	<td><?php echo $row['direccion_eps'] ?></td>
												 	<td><?php echo $row['telefono_eps'] ?></td>
												 	<td><?php echo $row['regimen_eps'] ?></td>
												    <td><a type="button" class="btn btn-default btn-sm" href="page-details.php?id=<?php echo $row['codigo_eps']; ?>"><span class="lnr lnr-eye"></span></a></td>
						...
						<div class="panel-footer">
							<a type="button" class="btn btn-primary" href="page-register.php">Nuevo</a>
						</div>
					</div>
					<!-- END OVERVIEW -->
