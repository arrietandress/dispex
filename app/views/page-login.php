...
<head>
	...
	<!-- VENDOR CSS -->
	<link rel="stylesheet" href="../include/template/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="../include/template/assets/vendor/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="../include/template/assets/vendinclude/template/or/linearicons/style.css">
	<!-- MAIN CSS -->
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="../include/template/assets/img/logo-dark.png" alt="Klorofil Logo"></div>
								<p class="lead">Ingrese a su cuenta</p>
							</div>
							<form class="form-auth-small" action="page-dasboard.php">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">SYSTEM DISPEX</h1>
							<p>Sistema para la Gestión y administración de medicamentos</p>
						</div>
					</div>
